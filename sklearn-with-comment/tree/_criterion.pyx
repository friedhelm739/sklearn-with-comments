...
cdef class ClassificationCriterion(Criterion):
    ...
    def __cinit__(self, SIZE_t n_outputs,
        ...
        self.sum_total = <double*> calloc(n_elements, sizeof(double))   # sum_total 代表每一类别的权重和
    ...
    cdef int reset(self) nogil except -1:
        ...
        for k in range(self.n_outputs):
            ...
            sum_total += self.sum_stride    # 初始化树结构，左子树为0样本，右子树为全部样本
            sum_left += self.sum_stride     # 指针操作 初始化每一output的结构 
